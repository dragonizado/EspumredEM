		...
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
                ...
                'actions'=>array('create','view','admin','listarCiudad','listarArticulo',
                    ...
                    'generarValor','generarDireccion','generarTelefono','generarTotal','listarEmpresas','actualizar','mostrarplantillaActualizar','generarNuevoCliente'),
                'users'=>array('@'),
                'expression'=>'Yii::app()->user->rol==="despacho"'
            ),
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update', 'view', 'update', 'admin','listarCiudad','listarArticulo',
					'listarUsuario','listarCliente','mostrarPlantilla','agregarItem','verArticulos','delete',
					'generarValor','generarDireccion','generarTelefono','generarTotal','delete','listarEmpresas','actualizar','mostrarplantillaActualizar'),
				'users'=>array('@'),
		...
		if(isset($_POST['Cartaremisora']))
		{
           ...
           for ($i=0; $i <count($models) ; $i++) { 
            ...
            for ($i=0; $i <count($Cliente) ; $i++) { 
               if ($Cliente[$i]['Nombre'].$Cliente[$i]['Apellido']==$arrCliente[0][0].$arrCliente[0][1]) {
                   $model->idCliente=$Cliente[$i]['id'];
               }
            }
