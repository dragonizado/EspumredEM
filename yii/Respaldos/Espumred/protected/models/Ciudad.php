...
class Ciudad extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('NombreCiudad', 'required'),
			array('id, NombreCiudad', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, NombreCiudad', 'safe', 'on'=>'search'),
	...
	public function relations()
	{
		...
		return array(
			'cartaremisoras' => array(self::HAS_MANY, 'Cartaremisora', 'Ciudad'),
			'prestamoses' => array(self::HAS_MANY, 'Prestamos', 'id_Ciudad'),
		);
	}
