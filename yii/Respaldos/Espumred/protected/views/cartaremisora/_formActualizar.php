...
<br><br><br><br>
  <div class="col-md-10">
        	...
        	<div class="col-md-4">
        		...
        		<?php echo $form->textField($model,'Flete_Pagadero',array('id'=>"flete",'size'=>45,'maxlength'=>45 ,'class'=>'form-control')); ?>
...
<br><br><br><br><br><br><br>
	...
	<div class="buttons col-md-10" align="center">
		 <?php echo CHtml::submitButton($model->isNewRecord ? 'Crear' : 'Guardar', array("id"=>"botonGuardar", "class"=>"btn btn-primary btn-large")); ?>
		 <br>
	</div>
