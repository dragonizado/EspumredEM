...
<div class="navbar navbar-default " role="navigation">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
         <a href="<?php echo Yii::app()->createUrl("site/index"); ?>"><img src="<?php echo Yii::app()->baseUrl;?>/images/logo.png" width='150px' height="50px"></a>
...
<footer class="footer bg-primary clearfix pd6">
 ...
 <!--section class="footer-credits">
  ...
  <link href="<?php echo Yii::app()->theme->baseUrl;?>/css/rating/jquery.js">
  </body>
</html>
