...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
            ...
            'updateButtonUrl'=>'Yii::app()->createUrl("/ciudad/update&id=$data->id" )', // url de la acción 'update'
            'viewButtonUrl'=>'Yii::app()->createUrl("/ciudad/view&id=$data->id" )', // url de la acción 'update'
            'deleteButtonUrl'=>'Yii::app()->createUrl("/ciudad/eliminar&id=$data->id")', // url de la acción 'delete'
