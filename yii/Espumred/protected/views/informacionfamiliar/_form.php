		      ...
		      function(data) {
		       ...
		       // alert(arrArticuloActual);
		        ...
		        for(var i=0; i< arrArticuloActual.length ;i++){
		         ...
		                       form = form+ 
		                       "<div width='100%'>"
		                         + "<div class='col-md-2 col-xs-4'>"+arrArticuloActual[i][1]+"</div>"
...
<div class="col-md-12">
	<div class="col-md-4" >
		...
		<?php echo $form->textField($model,'ccEmpleado',array('size'=>45,'id'=>"cc",'maxlength'=>45 ,'class'=>'form-control','value'=>$Registro[0]['cc'])); ?>
...
<div class="col-md-12">
	...
	<div class="col-md-4">
		...
		<?php echo $form->dropDownList($model,'escolaridad',array('NA'=>'NA','Primaria'=>'Primaria',
			'Sin Terminar Primaria'=>'Sin Terminar Primaria','Sin Terminar Secundaria'=>'Sin Terminar Secundaria','Secundaria'=>'Secundaria','Sin terminar Universidad'=>'Sin terminar Universidad',
			'Universitario'=>'Universitario','Tecnico'=>'Tecnico','Tecnologo'=>'Tecnologo',
...
<div class="container" id="Cartaremisora_descripcion" >
          ...
          <div class="panel panel-default">
      			 <div class="panel-heading col-md-2">
      		        <h3 class="panel-title">Nombre <span class="glyphicon"></span></h3>
      		      </div>
      		      <div class="panel-heading col-md-2">
      		        <h3 class="panel-title">Fecha nacimiento <span class="glyphicon"></span></h3>
      		      </div>
      		      <div class="panel-heading col-md-2">
      		        <h3 class="panel-title">Edad <span class="glyphicon"></span></h3>
      		      </div>
      		      <div class="panel-heading col-md-2">
      		        <h3 class="panel-title">Escolaridad <span class="glyphicon"></span></h3>
      		      </div>
      		      <div class="panel-heading col-md-2">
      		        <h3 class="panel-title">Ocupacion <span class="glyphicon"></span></h3>
      		      </div>
      		      <div class="panel-heading col-md-2">
      		        <h3 class="panel-title">vive con el <span class="glyphicon"></span></h3>
      		      </div>
