...
<div class="col-md-4">
	...
	<div >
		<?php echo $form->labelEx($model,'cedula empleado'); ?>
		<?php echo $form->textField($model,'cedula',array('size'=>45,'id'=>'cedula','maxlength'=>45 ,'class'=>'form-control','style'=>"text-transform:uppercase;")); ?>
