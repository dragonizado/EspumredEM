	...
	'columns'=>array(
		...
		array(
            ...
            'template'=>'{formacion}', 
              "buttons"=>array(
                    "formacion"=>array(
			'label'=>'Crear Formacion',
			'imageUrl'=>'images/cubo.png',
			//'click'=>new CJavaScriptExpression("formacion_click"),
			'url'=>'Yii::app()->createUrl("/formacion/cargar&id=$data->codLote")',
                    )),// botones a mostrar
            ...
            'afterDelete'=>'$.fn.yiiGridView.update("admin-grid");',
             // actualiza el grid después de borrar
		),
	),
)); ?>
