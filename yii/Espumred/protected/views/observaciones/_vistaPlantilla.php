   ...
   <thead>
   	<tr>
   		<td colspan="2" rowspan="3" align="center">
   			<img type="button" value="electr&oacute;nico"  onclick="window.open('<?php echo Yii::app()->request->baseUrl ?>/index.php?r=observaciones/MostrarPlantilla')" src="<?php echo Yii::app()->baseUrl;?>/images/logo_pequenio.png" width='250px' height="50px" style="margin-top: 10px;"> 
   		</td>
   	...
   	<tr align="center">
		...
		<tr align="center">
			...
			<td class="colorgris"><?php  echo $modeloCondicion["Otro1"]; ?></td>
		</tr>
		<tr align="center">
			...
			<td class="colorgris"><?php  echo $modeloCondicion["Otro2"]; ?></td>
		</tr>
   </thead>
   <tbody>
   ...
   <?php 
      ...
      $description2 = array(
         ...
         foreach ($description2 as $key => $value) {
            ...
            echo  "</td>";
            echo  "<td>";
            if($modeloCondicion["precioanterior".$count] != null){
            ...
            echo  "</td>";
            echo  "<td>";
                     if($modeloCondicion["nuevoprecio".$count] != null){
            ...
            echo  "</td>";
            echo  "<td>";
            if($modeloCondicion["piefactura".$count] != null){
            ...
            echo  "</td>";
            echo  "<td>";
                     echo $modeloCondicion["Otro".$otrocount]; 
            echo  "</td>";
            echo  "</tr>";
            $count++;
            $otrocount++;
           ...
           <span>FIRMA ASESOR: ________<u><?php echo $modeloInformacionPersonal["nombreAsesor"];?></u>________</span>   <span>FECHA:________<u><?php echo $model["fecha"];?></u>________</span>
            ...
            <div class="contenedor fila">
               <div class="gcontenedor" align="center">
                  <span>
                     ________<u><?php 
                     if($model["gerente_comercial"] != "CONDICIÓN RECHAZADA"){
                        echo $model["gerente_comercial"];
                     }else{
               ...
               <div class="gcontenedor" align="center">
                  <span>
                     ________<u><?php 
                        if($model["gerente_cartera"] != "CONDICIÓN RECHAZADA"){
                           echo $model["gerente_cartera"];
                        }else{
               ...
               <div class="gcontenedor" align="center">
                  <span>
                     ________<u><?php 
                     if($model["gerente_general"] != "CONDICIÓN RECHAZADA"){
                        echo $model["gerente_general"];
                     }else{
