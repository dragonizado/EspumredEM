        ...
        if (texto!="") {
            if (evaluar=="Cc") {
               ...
               if (!isNaN(texto)) {
                        ...
                        //    var valor="0";
                        $.post("<?php echo Yii::app()->request->baseUrl ?>/index.php?r=observaciones/guardarTexto", {texto: texto,evaluar:evaluar},
                        function(data) {                            
                           document.location.href =("<?php echo Yii::app()->request->baseUrl ?>/index.php?r=observaciones/buscar");
...
<div class="col-md-4">
     <div >
            ...
            <?php echo CHtml::dropDownList('listname',"", 
              array('Cod' => 'Cod', 'NombreCompleto' => 'NombreCompleto'),array('size'=>1,'maxlength'=>1 ,'id'=>"tipodeBusqueda",'class'=>'form-control','')); ?>
        <br>
    </div>
	<div>
        buscar
