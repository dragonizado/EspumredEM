...
<!--cabecera-->
sfdfsdfsdfsdfsdf <?php echo Yii::app()->utils->guid ?>
<table class="table table-bordered">
   <thead>
   	<tr>
   		<td colspan="2" rowspan="3" align="center">
   			<img type="button" value="electr&oacute;nico" onclick="window.print()" src="<?php echo Yii::app()->baseUrl;?>/images/logo_pequenio.png" width='250px' height="50px" style="margin-top: 10px;"> 
   		</td>
