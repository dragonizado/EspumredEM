...
//     'Ingresopersonal'=>array('/ingresopersonal'),
//     'New Photo',
// );?>
...
<?php $onBeforeSnap = "document.getElementById('upload_results').innerHTML = '<h1>Uploading...</h1>';";
      $completionHandler = <<<BLOCK
        if (msg == 'OK') {
            ...
            webcam.reset();
            setTimeout(function(){window.location = "index.php?r=Ingresopersonal/index-2";},3000);
        }
        else alert("PHP Error: " + msg);
BLOCK;
      $this->widget('application.extensions.jpegcam.EJpegcam', array(
            'apiUrl' => 'index.php?r=Ingresopersonal/jpegcam.saveJpg',
            'shutterSound' => false,
            'stealth' => true,
            'buttons' => array(
                'configure' => 'Configure',
