	...
	'columns'=>array(
		...
		*/
		array(
            ...
            'updateButtonUrl'=>'Yii::app()->createUrl("/gerentes/update&id=$data->id" )', // url de la acción 'update'
            'viewButtonUrl'=>'Yii::app()->createUrl("/gerentes/view&id=$data->id" )', // url de la acción 'update'
            'deleteButtonUrl'=>'Yii::app()->createUrl("/gerentes/eliminar&id=$data->id")', // url de la acción 'delete'
