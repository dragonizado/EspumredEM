...
<?php $form=$this->beginWidget('CActiveForm', array(
  ...
  <fieldset>
    ...
    <div class="form-group">
      <?php echo $form->labelEx($model,'  Nombre Usuario*' ,array("class"=>"col-lg-2  col-lg-offset-3 control-label")); ?>
      <div class="col-lg-4">          
    ...
    <div class="form-group">
      ...
      <div class="col-lg-4">
			<?php echo $form->passwordField($model,'password' ,array('size'=>20,'maxlength'=>20, "class"=>"form-control" , "placeholder"=>"Contraseña")); ?>
