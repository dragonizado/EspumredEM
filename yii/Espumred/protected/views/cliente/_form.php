...
<div class="col-md-4">
	...
	<div >
		...
		<?php echo $form->textField($model,'Apellido',array('size'=>45,'maxlength'=>45 ,'class'=>'form-control','style'=>"text-transform:uppercase;")); ?>
	...
	<div >
		...
		<?php echo $form->textField($model,'Direccion',array('size'=>45,'maxlength'=>45 ,'class'=>'form-control','style'=>"text-transform:uppercase;")); ?>
