...
//formas para obtener el dato particulas filtrandolo por un id
//los datos de condicionescomerciales estan en el modelo el empleado tiene todos los datos de el trascurso del proceso

$modeloInformacionPersonal=Condicionescomerciales::model()->findByPk($model['condicionescomerciales']);

$modeloCondicion=Condicion::model()->findByPk($model['refcondicion']);
$modeloObservaciones=Observaciones::model()->findByPk($model['observaciones']);
$modeloClientes=Observaciones::model()->findByPk($model['clientes']);
...
?>
 ...
 <style type="text/css">    
  ...
  <tbody>
	...
	<td class="col-md-3" align="center"><center>CONDICIONES COMERCIALES DEL CLIENTE<center>
...
<table class="table table-bordered "  >
			...
			<td colspan="12">
			Nombre del Cliente:     <?php $modeloClientes=Clientes::model()->findByPk($modeloInformacionPersonal["nombreCliente"]);
							        echo $modeloClientes["nombreCliente"] ;?>
            <td colspan="12">
