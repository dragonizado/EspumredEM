...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
            ...
            'updateButtonUrl'=>'Yii::app()->createUrl("/municipio/update&id=$data->id" )', // url de la acción 'update'
            'viewButtonUrl'=>'Yii::app()->createUrl("/municipio/view&id=$data->id" )', // url de la acción 'update'
            'deleteButtonUrl'=>'Yii::app()->createUrl("/municipio/eliminar&id=$data->id")', // url de la acción 'delete'
