...
$('.search-form form').submit(function(){
	$('#seguridadsocial-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Administrar Seguridad social</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
            ...
            'updateButtonUrl'=>'Yii::app()->createUrl("/segurosocial/update&id=$data->id" )', // url de la acción 'update'
            'viewButtonUrl'=>'Yii::app()->createUrl("/segurosocial/view&id=$data->id" )', // url de la acción 'update'
            'deleteButtonUrl'=>'Yii::app()->createUrl("/segurosocial/eliminar&id=$data->id")', // url de la acción 'delete'
