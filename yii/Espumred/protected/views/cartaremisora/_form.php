            ...
            var cliente= $("#NombreCliente").val();
              var direccion= $("#direccion").val();
               ...
               if (valor==0) {
                    ...
                    function(data) {
                      console.log(data);
                        document.getElementById("direccion").value=data;
                          $.post("<?php echo Yii::app()->request->baseUrl ?>/index.php?r=Cartaremisora/generarCedula", {cliente: cliente},
                              function(data) {
                            //console.log(data);
                             document.getElementById("cedula").value=data;
                            
                              cedula= $("#cedula").val();
                               $.post("<?php echo Yii::app()->request->baseUrl ?>/index.php?r=Cartaremisora/generarTelefono", {cliente: cliente, cedula:cedula},
                              function(data) {
                           // console.log(data);
                  ...
                  $.post("<?php echo Yii::app()->request->baseUrl ?>/index.php?r=Cartaremisora/generarNuevoCliente", {cliente: cliente, direccion:direccion , 
...
/* funcion  se activa cuando dan click en el campo ciudad lo que hace es ir a varias funciones  funcion la cual generara  y traera
    ...
    $("#NombreCiudad").on("click",function (event){
            ...
            // valor=$.post("<?php echo Yii::app()->request->baseUrl ?>/index.php?r=Cartaremisora/generarNuevoCliente", {cliente: cliente, direccion:direccion , 
            //   telefono:telefono, cedula:cedula},
            // function(data) {
            //   console.log(data);
            //      if (data=="1") {
...
<div class="col-md-10">
      ...
      <div class="col-md-4" id="formCedula">
        <?php echo $form->labelEx($model,'Cedula ó Nit*'); ?>
        <?php echo CHtml::textField('Text',"",array('id'=>"cedula" ,'size'=>45,'maxlength'=>45 ,'class'=>'form-control')); ?>
