...
<div class="col-md-4">
	...
	<div>
		...
		<?php echo $form->textField($model,'horaingreso',array('size'=>45,'maxlength'=>45 ,'class'=>'form-control')); ?>
	...
	<div>
		...
		<?php echo $form->textField($model,'horasalida',array('size'=>45,'maxlength'=>45 ,'class'=>'form-control','value'=>$hora)); ?>
	...
	<div>
		...
		<?php echo $form->textField($model,'estado',array('size'=>45,'maxlength'=>45 ,'class'=>'form-control','value'=>"Salida")); ?>
