            ...
            type:'get'
              ...
              if(done["frmhtml"] instanceof Object){
                $.each(done["frmhtml"],function(clave,valor){
                  ...
                  if(clave === "disabled"){
                    $.each(valor,function(index,valor2){
                      $("#"+valor2).attr({"disabled":true});
                    });
                  }else if(clave === "oculto"){
                    $.each(valor,function(index,valor2){
                ...
                alert("El sistema no se encuentra optimizado para procesar este tipo de pedido porfavor selecciona otro.");
              }
