...
<?php $form=$this->beginWidget('CActiveForm', array(
  ...
  <div class="col-md-4 CTX" >
       <?php echo $form->labelEx($model,'Equipo a Solicitar'); ?>
       <?php echo $form->dropDownList($model,'equipo_solicitar',array(''=>'','VideoBeam' => 'VideoBeam', 'Microfonos' => 'Microfonos',
      'Monitores' => 'Monitores', 'Sonido' => 'Sonido',
      'Computadora' => 'Computadora'
      ),array('size'=>1,'maxlength'=>1 ,'class'=>'form-control','id'=>'rh')); ?>
      <?php echo $form->error($model,'equipo_solicitar'); ?>
  </div>
  ...
  <div class="col-md-4 CTX" >      
     ...
     <?php echo $form->textField($model,'responsable' ,array('size'=>10,'maxlength'=>45 ,'class'=>'form-control','id'=>'cod' , )); ?>
