...
$this->menu=array(
	...
	array('label'=>'Crear Informacionempleado', 'url'=>array('create')),
);
...
<h1 align="center">Administrador Informacionempleados</h1>
	...
	'columns'=>array(
		...
		*/
		array(
            ...
            'updateButtonUrl'=>'Yii::app()->createUrl("/informacionempleado/update&id=$data->id" )', // url de la acción 'update'
            'viewButtonUrl'=>'Yii::app()->createUrl("/informacionempleado/view&id=$data->id" )', // url de la acción 'update'
            'deleteButtonUrl'=>'Yii::app()->createUrl("/informacionempleado/eliminar&id=$data->id")', // url de la acción 'delete'
