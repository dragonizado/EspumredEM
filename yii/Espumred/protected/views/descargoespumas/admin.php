...
$('.search-form form').submit(function(){
	$('#descargoespumas-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Administrador Descargoespumas</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
            ...
            'updateButtonUrl'=>'Yii::app()->createUrl("/descargoespumas/update&id=$data->id" )', // url de la acción 'update'
            'viewButtonUrl'=>'Yii::app()->createUrl("/descargoespumas/view&id=$data->id" )', // url de la acción 'update'
            'deleteButtonUrl'=>'Yii::app()->createUrl("/descargoespumas/eliminar&id=$data->id")', // url de la acción 'delete'
