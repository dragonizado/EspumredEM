...
class Informacionpersonal extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('cc, nombre, fechaNacimiento, lugarNacimiento, sexo, rh, estadoCivil, numeroHijos, direccionResidencia, barrio, municipio, telefono, celular', 'required'),
			array('cc', 'numerical', 'integerOnly'=>true),
			array('nombre, fechaNacimiento, lugarNacimiento, sexo, correo,rh, estadoCivil,tiempoCasado, numeroHijos, direccionResidencia, barrio, municipio, telefono, celular, libretaMilitar, claseLibretaMilitar', 'length', 'max'=>45), //el primer cc se agrego
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('cc, nombre, fechaNacimiento, lugarNacimiento, sexo,correo, rh, estadoCivil, numeroHijos,tiempoCasado, direccionResidencia, barrio, municipio, telefono, celular, libretaMilitar, claseLibretaMilitar', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		// NOTA: es posible que tenga que ajustar el nombre de la relación y la relacionada
        // Nombre de clase para las relaciones generadas automáticamente a continuación.
		return array(
			'informacionempleados' => array(self::HAS_MANY, 'Informacionempleado', 'informacionPersonal'),  //se pone como esta deteminada la tabla informacionpersonal// es informacionPersonal
	...
	public function search()
	{
		...
		$criteria->compare('cc',$this->cc,true);//en caso quitar true // //
