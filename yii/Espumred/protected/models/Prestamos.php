 ...
 * @property integer $valorUnitario
...
class Prestamos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			//array('id', 'required'),
			array('valorUnitario, valortotal, cantidad, consecutivo', 'numerical', 'integerOnly'=>true),
			array('id, id_Cliente, id_Usuario, id_Ciudad, id_Articulo', 'length', 'max'=>45),
			array('descripcion', 'length', 'max'=>10000),
			array('Fecha_Creacion, Fecha_Modificacion', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_Cliente, id_Usuario, id_Ciudad, id_Articulo, valorUnitario, valortotal, cantidad, Fecha_Creacion, Fecha_Modificacion, consecutivo, descripcion', 'safe', 'on'=>'search'),
