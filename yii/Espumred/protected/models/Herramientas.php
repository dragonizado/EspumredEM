 ...
 * @property string $fechaDeCompra
 * @property string $proveedor
 * @property string $fechaDeBaja
...
class Herramientas extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			//array('id', 'required'),
			array('id, nombre, descripcion, marca, fechaDeCompra, proveedor, fechaDeBaja, fabricante,estado', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nombre, descripcion, marca, fechaDeCompra, proveedor, fechaDeBaja, fabricante, estado', 'safe', 'on'=>'search'),
	...
	public function relations()
	{
		...
		return array(
			'registros' => array(self::HAS_MANY, 'Registro', 'idHerramienta'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('fechaDeCompra',$this->fechaDeCompra,true);
		$criteria->compare('proveedor',$this->proveedor,true);
		$criteria->compare('fechaDeBaja',$this->fechaDeBaja,true);
