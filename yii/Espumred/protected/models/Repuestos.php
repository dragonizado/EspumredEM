...
class Repuestos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			//array('id', 'required'),
			array('id, nombre, descripcion, marca, fechaDeCompra, proveedor, fechaDeBaja, fabricante', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nombre, descripcion, marca, fechaDeCompra, proveedor, fechaDeBaja, fabricante', 'safe', 'on'=>'search'),
	...
	public function relations()
	{
		...
		return array(
			'registros' => array(self::HAS_MANY, 'Registro', 'idRepuesto'),
		);
	}
