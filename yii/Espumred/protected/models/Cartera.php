...
class Cartera extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			//array('id', 'required'),
			array('id, gerenteCartera', 'required'),
			array('id, gerenteCartera, correo, fechaCreacion,fechaModificacion', 'length', 'max'=>45),
			array('FechaCreacion, FechaModificacion', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nombreGerente, correo, fechaCreacion, fechaModificacion', 'safe', 'on'=>'search'),
	...
	public function relations()
	{
		...
		return array(
			'gerentes0' => array(self::HAS_MANY, 'Observaciones', 'gerente_cartera'),
	...
	public function search()
	{
		...
		$criteria->compare('gerenteCartera',$this->gerenteCartera,true);
