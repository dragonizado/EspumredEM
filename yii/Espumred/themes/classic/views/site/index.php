                                                ...
                                                <div class="container-fluid">
                                                  ...
                                                  <div class="collapse navbar-collapse  navbar-ex2-collapse" id="bs-example-navbar-collapse-1">
                                                    <ul  class="nav navbar-nav">                                    
                                                      <li class="dropdown">
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">EXPORTAR <span class="caret"></span></a>
                                                        <ul class="dropdown-menu" role="menu">
                                                           <li><a href="<?php echo Yii::app()->createUrl("informacionempleado/generarExcelCarnet"); ?>">Carnet</a></li>
                                                          <li class="divider"></li>
                                                             <li><a href="<?php echo Yii::app()->createUrl("informacionempleado/generarExcelCuenta"); ?>">Cuenta</a></li>
                                                          <li class="divider"></li>
                                                            <li><a href="<?php echo Yii::app()->createUrl("dotacion/generarExcel"); ?>">Dotaciones</a></li>
                                                          <li class="divider"></li>
                                                         <li><a href="<?php echo Yii::app()->createUrl("dotacion/generarExcelEmpleado"); ?>">DotacionesRelacion</a></li>
                                                          <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("informacionempleado/generarExcel"); ?>">Empleados</a></li>
                                                          <li class="divider"></li>
                                                     ...
                                                     <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                          <li><a href="<?php echo Yii::app()->createUrl("informacionempleado/actualizar"); ?>">Actualizar</a></li>
                                                         <li class="divider"></li>
                                                         <li><a href="<?php echo Yii::app()->createUrl("informacionempleado/mostrarEmpleado"); ?>">Consultar</a></li>
                                                           <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("informacionpersonal/create"); ?>">Ingreso</a></li>
                                                            <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("informacionempleado/index"); ?>">Listar Empleado</a></li>
														                              <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("informacionpersonal/admin"); ?>">Buscar Empleado Sin Identificar</a></li>
                                                      ...
                                                      <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                          <li><a href="<?php echo Yii::app()->createUrl("articulosdedotacion/admin"); ?>">Dotacion</a></li>
                                                         <li class="divider"></li>
                                                         <li><a href="<?php echo Yii::app()->createUrl("cargos/admin"); ?>">Cargos</a></li>
                                                           <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("area/admin"); ?>">Areas</a></li>
                                                          <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("informacionempleado/mostrarRetiro"); ?>">Retiro</a></li>
                                                      ...
                                                      <li class="dropdown">
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">PORTERIA<span class="caret"></span></a>
                                                        <ul class="dropdown-menu" role="menu">
                                                          <li><a href="<?php echo Yii::app()->createUrl("vehiculo/menuinicio"); ?>">Vehiculo</a></li>
                                                            <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("registroconductores/menu"); ?>">Conductor</a></li>
                                                        </ul>
                                                      </li>

                                                      <li class="dropdown">
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">VISITANTES<span class="caret"></span></a>
                                                        <ul class="dropdown-menu" role="menu">
                                                          <li><a href="<?php echo Yii::app()->createUrl("ingresopersonal/create"); ?>">Crear Visitantes</a></li>
                                                            <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("ingresopersonal/adminpersonal"); ?>">Ver Visitas Ingresadas</a></li>
                                                        </ul>
                                                      </li>
                                                ...
                                                if ($diferencia_dias>"-12") {
                                                    ...
                                                    for ($j=0; $j <count($modelEmpleadoPrueba) ; $j++) { 
                                                      if ($modelContrato[$i]["id"]==$modelEmpleadoPrueba[$j]["contrato"]) {
                                                        ...
                                                        echo "El Empleado<b> ".$modelInformacionPersonal["nombre"]
                                                        ." </b>con cc <b>".$modelInformacionPersonal["cc"].
                                                        "</b> esta proximo a vencer periodo de prueba  con ".$diferencia_dias." dias de vigencia <br>";                                                       
                                                      };
                                                    };
                                                    ...
                                                    <ul  class="nav navbar-nav">                                    
                                                      <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                          ...
                                                          <li class="divider"></li>
                                                             <li><a href="<?php echo Yii::app()->createUrl("cliente/admin"); ?>">Cliente</a></li>
                                                          <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("ciudad/admin"); ?>">Ciudad</a></li>
                                                          <li class="divider"></li>
                                                           <li><a href="<?php echo Yii::app()->createUrl("cartaremisora/admin"); ?>">Carta Remisora</a></li>
                                                          <li class="divider"></li>
                                                             <li><a href="<?php echo Yii::app()->createUrl("empresa/admin"); ?>">Empresa</a></li>
                                                        
                                                            
                                                       </ul>
                                                      </li>
                                                     <li class="dropdown">
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">TALENTO HUMANO <span class="caret"></span></a>
                                                        <ul class="dropdown-menu" role="menu">
                                                          <li><a href="<?php echo Yii::app()->createUrl("informacionempleado/admin"); ?>">InformacionEmpleado</a></li>
                                                         <li class="divider"></li>
                                                         <li><a href="<?php echo Yii::app()->createUrl("informacionpersonal/admin"); ?>">InformacionPersonal</a></li>
                                                           <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("informacioneconomica/admin"); ?>">Informacioneconomica</a></li>
                                                            <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("informacionvivienda/admin"); ?>">Informacionvivienda</a></li>
                                                            <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("estadoestudiantil/admin"); ?>">Estadoestudiantil</a></li>
                                                      ...
                                                      <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                          <li><a href="<?php echo Yii::app()->createUrl("mecanicos/admin"); ?>">Mecanicos</a></li>
                                                         <li class="divider"></li>
                                                         <li><a href="<?php echo Yii::app()->createUrl("herramientas/admin"); ?>">Herramientas</a></li>
                                                           <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("repuestos/admin"); ?>">Respuestos</a></li>
                                                           <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("Registro/admin"); ?>">Registro</a></li>
                                                      ...
                                                      <li class="dropdown">
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">CREAR <span class="caret"></span></a>
                                                        <ul class="dropdown-menu" role="menu">
                                                          <li><a href="<?php echo Yii::app()->createUrl("informacionpersonal/create"); ?>">Crear Empleado</a></li>
                                                         <li class="divider"></li>
                                                         <li><a href="<?php echo Yii::app()->createUrl("cartaremisora/create"); ?>">Crear Carta Remisora</a></li>
                                                           <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("mecanicos/create"); ?>">Crear Mecanicos</a></li>
                                                           <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("mecanicos/MostrarMecanico"); ?>">InformeMecanico</a></li>
                                                          <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("herramientas/mostrarHerramientas"); ?>">InformeHerramientas</a></li>
                                                             <li class="divider"></li>
                                                            <li><a href="<?php echo Yii::app()->createUrl("usuario/create"); ?>">Crear Usuario</a></li>
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                         ...
                                                         <li><a href="<?php echo Yii::app()->createUrl("condicionescomerciales/admin"); ?>">Mostrar Condiciones Comerciales</a></li>
                                                           <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("clientes/create"); ?>">Añadir Cliente</a></li>
                                                           <li class="divider"></li>
                                                          <li><a href="<?php echo Yii::app()->createUrl("clientes/admin"); ?>">Mostrar clientes</a></li>
                                                  ...
                                                  <div class="collapse navbar-collapse  navbar-ex2-collapse" id="bs-example-navbar-collapse-1">
                                                    <ul  class="nav navbar-nav">                                    
                                                     ...
                                                     <li class="dropdown">
                                                      ...
                                                      <li class="dropdown">
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">INFORME <span class="caret"></span></a>
                                                        <ul class="dropdown-menu" role="menu">
                                                          <li><a href="<?php echo Yii::app()->createUrl("formacion/mostrarInforme"); ?>">Informe</a></li>
                                                         <li class="divider"></li>
                                                         <li><a href="<?php echo Yii::app()->createUrl("descargoespumas/admin"); ?>">Administrar</a></li>
                                                  ...
                                                  <div class="collapse navbar-collapse  navbar-ex2-collapse" id="bs-example-navbar-collapse-1">
                                                    <ul  class="nav navbar-nav">                                    
                                                     ...
                                                     <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                          <li><a href="<?php echo Yii::app()->createUrl("clientes/create"); ?>">Crear</a></li>
                                                         <li class="divider"></li>
                                                         <li><a href="<?php echo Yii::app()->createUrl("clientes/admin"); ?>">Administrar</a></li>
                                                     ...
                                                     <li class="dropdown">
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Descripcion<span class="caret"></span></a>
                                                        <ul class="dropdown-menu" role="menu">
                                                          <li><a href="<?php echo Yii::app()->createUrl("descripcion/create"); ?>">Crear Descripcion</a></li>                    
                                                         <li class="divider"></li>
                                                        <li><a href="<?php echo Yii::app()->createUrl("descripcion/admin"); ?>">Administrar Descripcion</a></li>
                                                          <li class="divider"></li>  
