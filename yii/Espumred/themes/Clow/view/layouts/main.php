...
<link href="<?php echo Yii::app()->theme->baseUrl;?>/css/jquery.dataTables.min.css" rel="stylesheet">
      ...
      <li class="dropdown">
          ...
          elseif(Yii::app()->user->rol=='admin'){
                ...
                $menuItems = array(
                    'htmlOptions'=>array("class"=>"nav navbar-nav navbar-right"),
                    'items'=>array(
                     array('label'=>'TALENTO HUMANO', 'url'=>array('condicioncomercial/informe')),
...
<script type="text/javascript" src="//maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js"></script>
  ...
  <!-- <script type="text/javascript" src="<?# echo Yii::app()->theme->baseUrl;?>/js/jquery.js"></script> -->
